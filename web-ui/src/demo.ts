...
export const demoItems: UiItem[] = [
  ...
  { type: "assistant_message", id: "a1", text: "I’ll add validation with Zod and return clear `400` responses.", streaming: false },
  ...
  { type: "approval", id: "p1", requestId: 99, description: "npm install zod", status: "pending", decisions: ["accept", "acceptForSession", "decline"], approvalKind: "command" },
];
